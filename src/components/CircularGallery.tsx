...
class Media {
    ...
    onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
        ...
        const scaleFactor = isMobile ? 0.6 : 1; // 60% del tamaño original
...
class App {
    ...
    createCamera() {
        ...
        this.camera.position.z = isMobile ? 28 : 20; // más lejos en móvil
    }
    ...
    createMedias(
        ...
        const defaultItems = [
            ...
            {
                image: `https://img.icons8.com/color/480/wordpress.png`,
                text: 'Wordpress'
            },
            {
                image: `https://img.icons8.com/color/480/php.png`,
                text: 'PHP'
            },
            {
                image: `https://img.icons8.com/?size=100&id=Z-e7GFgHGFVM&format=png&color=000000`,
                text: 'Laravel'
            },
            {
            ...
            {
                image: `https://img.icons8.com/color/480/git.png`,
                text: 'Git'
            },
            {
